...
/**
 * <h3>Purpose</h3>
 * DTO carrying the data payload required to create a new Task.
 *
 * <h3>Flow</h3>
 * 1. Received as a JSON payload in the POST request body `/api/v1/milestones/{milestoneId}/tasks`.<br/>
 * 2. Deserialized and validated by Spring MVC using JSR-380 annotations.<br/>
 * 3. Passed to the TaskService.createTask method.<br/>
 * 4. Mapped to the Task entity by the TaskMapper.
 *
 * <h3>Testing Approach</h3>
 * 1. Unit testing with JSR-380 Validator (ValidatorFactory) to assert validation rule violations on blank title, null status, or negative estimated hours.<br/>
